...
#include <QSpinBox> // para crear inputs con botones de arriba/abajo
#include <QTimer> // para establecer el temporizador
    ...
    : QWidget{parent}
{
    ...
    */
    ...
    // AREA PARA CONECTAR SEÑALES Y SLOTS
    {
        ...
        //SEÑALES RELACIONADAS CON LA INTERFAZ HIPERFOCO
